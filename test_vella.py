...
han = HansonModel(
twist_rad = np.deg2rad(pitch * np.ones(r_outer.shape)), # blade twist array [rad] of size Nr+1 (segment edges)
chord_m = c * np.ones(r_outer.shape), # blade chord array [m] of size Nr+1
