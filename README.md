...
Note this is a working repository; many scripts may be out-of-date, implementation may have bugs.
For a stand-alone python module of the code, please refer to: https://github.com/jdsiemaszko/PropAcousticsPy.
Mind that the package may not be up-to-date with respect to this repo.
...
For usage, see script "Hanson_example.py".
